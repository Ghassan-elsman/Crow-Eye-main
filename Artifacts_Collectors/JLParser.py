# based on work by Saleh Muhaysin
import json
import struct
import uuid
import datetime
...
class JL:
    ...
    def parse_Lnk(self, stream):
        ...
        LnkStreamHeader = {
            ...
            'File_Attributes'    : self.get_file_attr_flags(self.unpack_int_l(stream_header[24:28])),
    ...
    def handle_output(self, output):
        ...
        if self.output_format.lower() == 'json':
            output_text = self.json_beautifier( output ) 
...
def Claw(filename):
    ...
    optionalargs.add_argument('-a', dest='appids_file', help=f'AppIDs configuration file (default: {appid_path})')
